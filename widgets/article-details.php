...
class Rentware_Article_Details extends \Elementor\Widget_Base
{

  public function get_name()
  {
    return 'rtrElementorAddon_article_details';
  }

  public function get_title()
  {
    return esc_html__('Rentware Article Details', 'rentware-addon-for-elementor');
  }
...
?>
    <rtr-article article-id="<?php echo esc_attr($settings['article_id']); ?>" view="<?php echo esc_attr($settings['view']); ?>"></rtr-article>
  ...
  ?>
    <# if (settings.article_id) { #>
      <rtr-article article-id="{{ settings.article_id }}" view="{{ settings.view }}"></rtr-article>
      <# } else { #>
